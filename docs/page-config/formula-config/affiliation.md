...
<Tabs>
  <TabItem value="person-only" label="单独选人" default>
    <Tabs>
      <TabItem value="many" label="多选" default>
        ```json
        {
          ...
          "data": [
            {
              ...
              "controlData": {
                "controlType": "REFERENCE",
                "controlProperties": "{\"appName\":\"organization\",\"fullName\":\"com.seeyon.organization.domain.core.entity.OrgMember\",\"multi\":false}"
              },
              "uid": "8ff482f6-13f8-4691-81b9-3d8e7ab97679"
            }
          ]
  ...
  <TabItem value="dept-only" label="单独选部门">
    <Tabs>
      <TabItem value="many" label="多选" default>
        ```json
        {
  ...
  <TabItem value="person-affiliated" label="人员隶属">
    ```json
    {
      "type": "__EXPRESS_TOKENS",
      "data": [
